...
function init() {
    ...
    // init camera
    camera = new THREE.PerspectiveCamera(60, window.innerWidth / (2*window.innerHeight), 0.1, 100);
    ...
    textureLoader.load("./textures/2k_jupiter_n.jpg", function (map) {
        map.anisotropy = 4;
        map.encoding = THREE.sRGBEncoding;
        earthMat.map = map;
        earthMat.needsUpdate = true;
    });
    textureLoader.load("./textures/2k_jupiter_normals.jpg", function (map) {
        map.anisotropy = 4;
        map.encoding = THREE.sRGBEncoding;
